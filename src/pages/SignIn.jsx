        ...
        <div className="auth-fade grid w-full overflow-hidden rounded-3xl border border-blue-100 bg-white/90 shadow-2xl backdrop-blur md:grid-cols-[1.1fr_1fr]">
          <div className="hidden flex-col justify-between bg-gradient-to-br from-blue-800 via-blue-700 to-sky-600 p-10 text-white md:flex">
            ...
            <div className="auth-stagger space-y-3 text-sm text-blue-50">
              <div className="flex items-center gap-3 rounded-2xl bg-white/10 px-4 py-3">
                <span className="rounded-full bg-white/20 px-3 py-1 text-xs font-semibold">Rx</span>
                <span>Track prescriptions and patient history seamlessly.</span>
              </div>
              <div className="flex items-center gap-3 rounded-2xl bg-white/10 px-4 py-3">
                <span className="rounded-full bg-white/20 px-3 py-1 text-xs font-semibold">Stock</span>
                <span>Never miss a low-stock or expiry alert again.</span>
              </div>
              <div className="flex items-center gap-3 rounded-2xl bg-white/10 px-4 py-3">
                <span className="rounded-full bg-white/20 px-3 py-1 text-xs font-semibold">POS</span>
                <span>Faster checkouts with integrated receipts.</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center p-8 md:p-10">
            <div className="auth-rise mb-6">
              ...
              <h2 className="mt-4 text-2xl font-extrabold text-gray-900">Sign in to PharmSuite</h2>
            </div>
